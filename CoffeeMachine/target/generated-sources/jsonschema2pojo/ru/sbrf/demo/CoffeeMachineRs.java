...
public class CoffeeMachineRs {
    ...
    @JsonProperty("HasMilkBeenAdded")
    private Boolean hasMilkBeenAdded;
    @JsonIgnore
    ...
    @JsonProperty("HasMilkBeenAdded")
    public Boolean getHasMilkBeenAdded() {
        return hasMilkBeenAdded;
    }

    @JsonProperty("HasMilkBeenAdded")
    public void setHasMilkBeenAdded(Boolean hasMilkBeenAdded) {
        this.hasMilkBeenAdded = hasMilkBeenAdded;
    }
    ...
    public String toString() {
        ...
        sb.append(CoffeeMachineRs.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        ...
        sb.append(',');
        sb.append("hasMilkBeenAdded");
        sb.append('=');
        sb.append(((this.hasMilkBeenAdded == null)?"<null>":this.hasMilkBeenAdded));
        sb.append(',');
    ...
    public int hashCode() {
        ...
        result = ((result* 31)+((this.hasMilkBeenAdded == null)? 0 :this.hasMilkBeenAdded.hashCode()));
        return result;
    }
