...
public class BaristaRq {
    ...
    public String toString() {
        ...
        sb.append(BaristaRq.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof BaristaRq) == false) {
            return false;
        }
        BaristaRq rhs = ((BaristaRq) other);
